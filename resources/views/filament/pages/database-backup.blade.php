<x-filament-panels::page>
        <div class="space-y-8">
            ...
            <!-- Restore Section -->
            <div class="p-4 bg-gray-800 rounded shadow">
                <h2 class="text-lg font-bold text-gray-100 mb-4">استعادة النسخة</h2>
            ...
            <div class="p-4 bg-gray-800 rounded shadow">
                <h2 class="text-lg font-bold text-gray-100 mb-4">النسخ السابقة</h2>
                <table class="w-full text-left border border-gray-200">
                    <thead>
                        <tr class="bg-gray-700">
                            <th class="border border-gray-600 px-4 py-2 text-gray-300">اسم النسخة</th>
                            <th class="border border-gray-600 px-4 py-2 text-gray-300">الحجم</th>
                            <th class="border border-gray-600 px-4 py-2 text-gray-300">اخر تعديل</th>
                            <th class="border border-gray-600 px-4 py-2 text-gray-300">الإجراءات</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($this->backups as $backup)
                            <tr class="hover:bg-gray-700">
                                ...
                                <td class="border border-gray-600 px-4 py-2">
                                    {{-- <a href="{{ $backup['url'] }}" target="_blank" class="text-blue-400 hover:underline">تحميل</a> --}}
